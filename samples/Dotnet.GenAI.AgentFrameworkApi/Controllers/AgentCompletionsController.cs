using Dotnet.GenAI.AgentFrameworkApi.Contracts;
...
namespace Dotnet.GenAI.AgentFrameworkApi.Controllers
{
    /// <summary>
    ...
    public sealed class AgentCompletionsController : ControllerBase
    {
        ...
        public AgentCompletionsController(
            ChatCompletionAgent agent, 
            ILogger<AgentCompletionsController> logger)
        {
            _agent = agent;
            _logger = logger;
        }
        ...
        public async Task<IActionResult> CompleteAsync(
            [FromBody] AgentCompletionRequest request, 
        ...
        private async IAsyncEnumerable<ChatMessageContent> CompleteAsync(
        ...
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns>The completion result.</returns>
        private async IAsyncEnumerable<StreamingChatMessageContent> CompleteSteamingAsync(
            ChatHistory chatHistory, 
            KernelArguments arguments, 
            [EnumeratorCancellation] CancellationToken cancellationToken)
        {
